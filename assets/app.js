...
/* Фирменный знак EXDED. Собран из exded-logo-transparent-512.png — других источников знака нет.
   logo — для интерфейса, значка вкладки и значка «На экран «Домой»».
   pdf  — тот же знак для шапки документов: маска и доли самого знака в картинке. */
window.EXDED_BRAND = {
  logo: 'data:image/png;base64,',
  pdf: { w: 512, h: 512, mask: '', ink: [0.1406, 0.1738, 0.7188, 0.6523] },
};
...
window.ExdedDocs = (() => {
  ...
  /* Фирменный знак в шапке. Источник тот же, что у интерфейса и значков —
     window.EXDED_BRAND (его кладёт сборка из exded-logo-transparent-512.png).
     В PDF знак идёт маской: один бит на точку, краска — цвет из op.color.
     Нет константы (docs.js подключили отдельно) — шапка просто без знака. */
  const brandMark = () => {
    const b = (window.EXDED_BRAND || {}).pdf;
    return b && b.mask && b.w && b.h ? b : null;
  };
  ...
  function render(ops) {
    ...
    for (const op of ops) {
      ...
      if (op.t === 'rect') {
        ...
        out.push('q');
        out.push(`${f3(op.w)} 0 0 ${f3(op.h)} ${f3(op.x)} ${f3(PAGE.h - op.y - op.h)} cm`);
        out.push('/Im0 Do');
        out.push('Q');
      } else if (op.t === 'text') {
...
<div class="cs-foot">
  ...
  /* Фирменный знак. Источник один — window.EXDED_BRAND.logo (его кладёт сборка).
     ...
     внешних файлов нет, поэтому единый HTML работает и без сети. */
  function applyBrand() {
